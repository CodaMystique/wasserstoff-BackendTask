...
const PORT = 3002; // Set the port for process 2 (this will represent another worker process in the round-robin system)
...
// Start the Express backend server and listen on the specified port (3002)
app.listen(PORT, () => {
