...
const PORT = 3003; // Set the port for process 3 (this represents another worker process in the round-robin system)
...
// Start the Express backend server and listen on the specified port (3003)
app.listen(PORT, () => {
